...
void main() {
  test('Reproduction: Alignment format loss after read/write', () {
    ...
    print(
        'Original Alignment: H=${cellStyle.horizontalAlignment}, V=${cellStyle.verticalAlignment}, R=${cellStyle.rotation}');
    print(
        'Decoded Alignment: H=${cell2.cellStyle?.horizontalAlignment}, V=${cell2.cellStyle?.verticalAlignment}, R=${cell2.cellStyle?.rotation}');

    expect(
        cell2.cellStyle?.horizontalAlignment, equals(HorizontalAlign.Center));
