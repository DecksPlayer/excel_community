...
This guide explains the color strategy, palettes, transparency levels, and design principles applied to different chart types in the `excel_community` library.
...
### Automatic Rotation
If there are more than 12 series, colors are reused using `index % 12`.
...
- Colors are sufficiently different from each other to avoid visual confusion.

### 2. Strategic Transparency
- **Area/Radar charts:** Transparency is utilized to see overlaps.
- **Bar/Scatter charts:** Solid fills are utilized for maximum clarity.
...
### 4. Professionalism
- Colors based on standard Office/Excel palettes (neither too bright nor too dull).

### 5. Accessibility
- Includes tone variations (light/dark) with strong contrast levels.
...
### Measurement Units
- **EMUs (English Metric Units):** 914,400 EMUs = 1 inch.
- **Thin line thickness:** 9,525 EMUs ≈ 0.75 pt.
- **Thick line thickness:** 28,575 EMUs ≈ 2.25 pt.
