...
Future<String> generateMergedCellsHelper() async {
  ...
  if (kIsWeb) {
    final bytes = excel.save(fileName: 'merged_cells_report.xlsx');
    if (bytes != null && bytes.isNotEmpty) {
      return '✅ Multi-sheet Excel with merged cells generated successfully!\n'
          'File size: ${(bytes.length / 1024).toStringAsFixed(2)} KB\n'
          'The download should start automatically.\n'
          '📌 Includes: Project Roadmap and Shift Schedule sheets.';
    }
    ...
    String? outputFile = await FilePicker.platform.saveFile(
      dialogTitle: 'Save Merged Cells Excel',
      fileName: 'merged_cells_report.xlsx',
    ...
    if (outputFile != null) {
      ...
      return '✅ Multi-sheet Excel with merged cells saved successfully!\n'
          'Location: $outputFile';
    }
